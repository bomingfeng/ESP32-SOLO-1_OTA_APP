    ...
    while(1)
    {
                      ...
                      (APP_event_run_BIT | APP_event_30min_timer_BIT | APP_event_ds18b20_CONNECTED_flags_BIT)))
        {
                ...
                if(((bleC >= (IR_temp + Sp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_SP_flags_BIT) == 0)) || \
                    ((ds18b20C >= (IR_temp + Sp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_SP_flags_BIT) == 0)))
                {
                    //开
#ifdef  Gree 
                    /*  ir_ps_data[0] = 0x50;
...
ir_ps_data[12] = 0x12;
                ...
                */
                ...
                if(((bleC <= (IR_temp - Lp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_LP_flags_BIT) == 0)) || \
                    ((ds18b20C <= (IR_temp - Lp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_LP_flags_BIT) == 0)))
                {
                    //关
#ifdef  Gree 
                    /*  
...
ir_ps_data[12] = 0x32;
                ...
                if(((bleC <= (IR_temp - LLp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_LLP_flags_BIT) == 0)) || \
                    ((ds18b20C <= (IR_temp - LLp)) && ((xEventGroupGetBits(APP_event_group)  & APP_event_LLP_flags_BIT) == 0)))
                {
                    //全关
#ifdef  Gree 
                    /*  
